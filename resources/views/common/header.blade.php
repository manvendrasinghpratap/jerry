<header class="navbar navbar-header navbar-header-fixed">
      ...
      <div id="navbarMenu" class="navbar-menu-wrapper">
        <div class="navbar-menu-header">
          <a href="{{ url('/')}}" class="df-logo">JCH <span> CMS</span></a>
          <a id="mainMenuClose" href="#"><i data-feather="x"></i></a>
        </div><!-- navbar-menu-header -->
        <ul class="nav navbar-menu">
          <li class="nav-label pd-l-20 pd-lg-l-25 d-lg-none">Main Navigation</li>
          <li class="nav-item with-sub">
            <a href="#" class="nav-link"><i data-feather="pie-chart"></i>QA</a>
          ...
          <li class="nav-item with-sub">
            <a href="#" class="nav-link"><i data-feather="package"></i> HR</a>
            <ul class="navbar-menu-sub">
          ...
          <li class="nav-item with-sub">
            <a href="#" class="nav-link"><i data-feather="package"></i> PT-OT</a>
            <ul class="navbar-menu-sub">
              <li class="nav-sub-item"><a href="app-calendar.html" class="nav-sub-link"><i data-feather="calendar"></i>Calendar</a></li>
            </ul>
          </li>
            ...
            <div class="navbar-menu-sub">
              <div class="d-lg-flex">
                ...
                <ul>
                  ...
                  <li class="nav-label mg-t-20">SMS</li>
          ...
          <li class="nav-item"><a href="http://themepixels.me/dashforge/components/" class="nav-link"><i data-feather="box"></i> File Downloads</a></li>
          <li class="nav-item"><a href="http://themepixels.me/dashforge/collections/" class="nav-link"><i data-feather="archive"></i> Nurse Home Visit</a></li>
          <li class="nav-item"><a href="http://themepixels.me/dashforge/collections/" class="nav-link"><i data-feather="archive"></i> Caregiver</a></li>
          <li class="nav-item"><a href="http://themepixels.me/dashforge/collections/" class="nav-link"><i data-feather="archive"></i> Med-Tech</a></li>
        </ul>
      </div><!-- navbar-menu-wrapper -->
      <!-- to check where user is login aur not begin-->
      @auth
      <div class="navbar-right">
        ...
        <div class="dropdown dropdown-profile">
          ...
          <div class="dropdown-menu dropdown-menu-right tx-13">
            ...
            <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();  document.getElementById('logout-form').submit();"><i data-feather="log-out"></i> {{ __('Logout') }}      </a><form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">@csrf</form>
          </div><!-- dropdown-menu -->
        </div><!-- dropdown -->
      </div><!-- navbar-right -->
      <!-- to check where user is login aur not begin-->
